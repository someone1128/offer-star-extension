...
5. 新增站点必须同时修改 `src/shared/site-adapters.ts`、新增脱敏 HTML 夹具和测试，并更新 `docs/真实站点回归矩阵.md`。
...
先阅读 [CLAUDE.md](CLAUDE.md) 了解项目上下文，再阅读 [后续工作与交接清单](docs/后续工作与交接清单.md) 获取当前任务顺序，最后按 [开发与验收计划](docs/开发与验收计划.md) 执行验收。
