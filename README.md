...
开发阶段的阶段规划、交互基线、站点适配规则和测试完成标准见 [开发与验收计划](docs/DEVELOPMENT_AND_TEST_PLAN.md)；真实站点的公开入口和回归状态见 [真实站点回归矩阵](docs/SITE_REGRESSION_MATRIX.md)，需要用户登录的页面见 [真实回归登录清单](docs/LOGIN_REQUIRED_SITE_CHECKLIST.md)。
